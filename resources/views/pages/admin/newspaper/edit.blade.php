...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Newspaper</div>
                <div class="card-body">
                        ...
                        <div class="row mb-3 justify-content-center">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea id="tinymce" name="description" class="form-control @error('description') is-invalid @enderror"> {{ old('description', $newspaper->description) }}</textarea> </textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
